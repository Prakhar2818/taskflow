...
const ToggleSwitch = ({ enabled, onChange }) => (
  ...
  >
    <div className={`absolute top-1 w-4 h-4 bg-white rounded-full transition-transform duration-200 ${enabled ? 'transform translate-x-7' : 'transform translate-x-1'
      }`} />
  </button>
);
...
const SettingsPage = () => {
  ...
  const [settings, setSettings] = useState({
    darkMode: localStorage.getItem('taskflow-theme') === 'dark',
    notifications: true,
    autoSave: true,
    emailUpdates: false,
    soundEffects: true
