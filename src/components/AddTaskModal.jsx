...
const AddTaskModal = () => {
  const { addTask, showModal, setShowModal } = useTaskContext();
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <div 
        className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg transform transition-all duration-200 animate-scale-in"
        style={{
